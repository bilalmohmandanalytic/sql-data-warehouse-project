/*
===========================================================================
Stored Procedure: Load Bronze Layers (Sources -> Bronze)
===========================================================================
Scripts Purpose:
        This Store procedure load the data into the 'Bronze' schema from external csv files.
         it performs the following actions
             -Truncate the bronze tables before the loading data.
...
PRINT '================================';
PRINT 'Loading bronze layers is Completed';
...
BEGIN CATCH
PRINT '=====================================================================';
PRINT 'ERROR OCCURED DURING BRONZE LAYERS';
